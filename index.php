...
<body class="hero">
    ...
    <div class="container hero-content mt-5 d-flex d-flex-column justify-content-center align-items-center">
        <div class="row justify-content-center text-center">
            <div class="col-12 pt-5 mt-5">
                <h1 class="display-1 fw-bold">Bosvark Consulting Group</h1>
                <p class="display-4">Unparalleled expertise in hostile environments.</p>
            </div>
            <div class="col-12 my-5 pb-5">
                <div class="row justify-content-center mx-3">
                    <div class="col-md-4 mb-3">
                        <a class="btn btn-primary rounded-pill w-100 h-2em" href="#about">About Us</a>
                    </div>
                    <div class="col-md-4 mb-3">
                        <a class="btn btn-primary rounded-pill w-100" href="#services">Our Services</a>
                    </div>
                    <div class="col-md-4 mb-3">
                        <a class="btn btn-primary rounded-pill w-100" href="#contact">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid surface-1" id="about">
        <div class="container">
            <div class="row ">
                <div class="col-md-4 px-5">
                    <img class="w-100" src="assets/logo.avif" alt="Bosvark Consulting Group Logo">
                </div>
                <div class="col-md-8">
                    <h2 class="my-5">Welcome to Bosvark Consulting Group</h2>
                    <p>
                        We are privileged to be entrusted and to work with the biggest defence manufacturers, as well as
                        some of the most specialised military equipment suppliers in the world. Our clients trust us to
                        ensure the most critical part of their business is handled effectively.
                    </p>
                    <p>
                        We are fully compliant with the Department of International Trade in the sale, brokering and
                        exporting of controlled goods.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row my-5">
                <div class="col-12">
                    <h2 class="mb-5 text-center">About Bosvark</h2>
                ...
                <div class="col-12">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <div class="row d-flex align-items-stretch">
                                <div class="col-md-4 d-flex">
                                    <img src="assets/service-bg1.avif" alt="Man working on drone in workshop"
                                        class="img-fluid w-100 d-none d-md-block" style="object-fit: cover;">
                                </div>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="row d-flex align-items-stretch">
                                <div class="col-md-4 d-flex">
                                    <img src="assets/service-bg2.avif"
                                        alt="Team building infrastructure in developing countries"
                                        class="img-fluid w-100 d-none d-md-block" style="object-fit: cover;">
                                </div>
                                <div class="col-md-8 d-flex flex-column">
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <div class="row d-flex align-items-stretch">
                                <div class="col-md-4 d-flex">
                                    <img src="assets/service-bg3.avif" alt="Teaching military personnel in a classroom"
                                        class="img-fluid w-100 d-none d-md-block" style="object-fit: cover;">
                                </div>
                                <div class="col-md-8 d-flex flex-column">
        ...
        <div class="container" id="ukraine">
            <div class="row mt-5">
                <div class="col">
                    <h2 class="mb-5 text-center">Ukraine</h2>
                    ...
                    <p class="text-center mt-5"><a href="www.sabretag.org">www.sabretag.org</a></p>
                </div>
            </div>
        </div>
