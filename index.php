    ...
    <div class="container hero-content mt-5 d-flex d-flex-column justify-content-center align-items-center">
        <div class="row justify-content-center text-center">
            <div class="col-12 pt-5 mt-5">
                <h1>Bosvark Consulting Group</h1>
                <h3>Unparalleled expertise in hostile environments.</h3>
            </div>
            <div class="col-12 my-5 pb-5">
                <div class="row justify-content-center">
                    <div class="col-4 col-md-3">
                        <a class="btn btn-primary w-100">Our Services</a>
                    </div>
                    <div class="col-4 col-md-3">
                        <a class="btn btn-primary w-100">About Us</a>
                    </div>
                    <div class="col-4 col-md-3">
                        <a class="btn btn-primary w-100">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
